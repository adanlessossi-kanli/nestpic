...
- [ ] 2. Implement the lint and type-check jobs
  - [ ] 2.1 Add the `lint` job to `ci.yml`
  ...
  - [ ] 2.2 Add the `type-check` job to `ci.yml`
    - Runs on `ubuntu-latest`, no `needs:` dependencies
...
- [ ] 3. Implement the unit-tests job
  - [ ] 3.1 Add the `unit-tests` job to `ci.yml`
  ...
  - [ ] 3.2 Write property test for job runner and Node version invariants
...
- [ ] 4. Implement the e2e-tests job
  - [ ] 4.1 Add the `e2e-tests` job to `ci.yml`
  ...
  - [ ] 4.2 Write property test for E2E env var consistency
...
- [ ] 5. Implement the build job
  - [ ] 5.1 Add the `build` job to `ci.yml`
  ...
  - [ ] 5.2 Write property test for build job stub env vars
...
- [ ] 6. Implement the docker-publish job
  - [ ] 6.1 Add the `docker-publish` job to `ci.yml`
  ...
  - [ ] 6.2 Write property tests for secret scoping and job dependency graph
...
- [ ] 8. Create CI/CD documentation
  - [ ] 8.1 Create `docs/cicd.md`
